	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if(strpos($text, 'hosico') !== false){
				$messages = [
					'type' => 'imagemap',
					"baseUrl" => "https://scontent.fbkk2-1.fna.fbcdn.net/v/t31.0-8/18320826_272813646460639_3269795860273210556_o.jpg?oh=558c30fe59ec7a1a8f45ced872eb4fff&oe=59A2A1D1/700",
					"altText" => "Hosico naja",
					"baseSize" => [
      					"height" => 1040,
      					"width" => 1040
